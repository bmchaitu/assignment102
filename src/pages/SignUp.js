...
function SignUp() {
	...
	async function handleSubmit(ev){
		ev.preventDefault();
		axios.post('https://blooming-taiga-58489.herokuapp.com/register',state)
		.then((result) => {
			setUser({
	...
	return(
    	...
    	<form className="form-signin" onSubmit={handleSubmit}>
        	...
        	<input type="email" name="username" onChange={handleChange} id="inputEmail" className="form-control" placeholder="Email address" required autoFocus/>
        	<input type="password" name="password" id="inputPassword" onChange={handleChange} className="form-control my-3" placeholder="Password" required/>
